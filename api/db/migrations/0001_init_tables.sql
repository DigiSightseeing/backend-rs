...
CREATE TABLE IF NOT EXISTS "TourLocationTag" (
    id UUID PRIMARY KEY DEFAULT uuid_generate_v4 (),
    "name" VARCHAR(255) NOT NULL
);

CREATE TABLE IF NOT EXISTS "TourLocationTags" (
...
CREATE TABLE IF NOT EXISTS "TourLocations" (
...
CREATE TABLE IF NOT EXISTS "TourUsers" (
    tour_id UUID NOT NULL,
...
CREATE TABLE IF NOT EXISTS "TourTag" (
    id UUID PRIMARY KEY DEFAULT uuid_generate_v4 (),
    "name" VARCHAR(255) NOT NULL
);
...
CREATE TABLE IF NOT EXISTS "TourLocationReview" (
    id UUID PRIMARY KEY DEFAULT uuid_generate_v4 (),
    location_id UUID NOT NULL,
    user_id UUID NOT NULL,
    rating INT NOT NULL,
...
CREATE TABLE IF NOT EXISTS "TourLocationReviews" (
    location_id UUID NOT NULL,
    review_id UUID NOT NULL,
